...
function checkFun(id) {
	$('#' + id + ' tbody input[type=checkbox]').click(function() {
		checkStats(id);
	});
...
function checkStats(id) {
	var result = true;
	$('#' + id).find('tbody input[type=checkbox]').each(function() {
	...
	if (result) {
		...
		$('#' + id).find('thead input[type=checkbox]').removeAttr('checked');
	}
}

function checkAll(id) {
	if ($('#' + id).find('thead input[type=checkbox]').prop('checked')) {
		$('#' + id).find('tbody input[type=checkbox]').each(function() {
