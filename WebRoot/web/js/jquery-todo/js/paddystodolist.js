$(document).ready(function() {
    ...
    $('#addItem').click(function(e) {
        ...
        // Then empty the input field ready for the next input.
            ...
            $('<li class="toDo"><a href="javascript:;" class="remove"><i class="fa fa-times"></i></a><i style="padding-left: 10px;">' + $newItemText + '</i><</li>').prependTo('#toDoList').hide().slideDown('fast');
