/**
 * Created by qulongjun on 16/2/29.
 */
...
var leipiFormDesign = {
    ...
    fnCheckForm: function (type) {
        ...
        if (leipiEditor.hasContents()) {
            ...
            //解析表单设计器控件
            var parse_form = this.parse_form(formeditor, fields); //生成JSON形式的表单控件
            formeditor = formeditor.replace(/-\|}/ig,'').replace(/{\|-/ig,'');
