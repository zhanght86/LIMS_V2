var App = function () {
	...
	return {
        ...
        init: function () {
			...
			if(App.isPage("repository")){
				handleBootbox(); //Function to display Date Timepicker
			}
			if(App.isPage("agreement_midel")){
				handleToggle();
			}
			if(App.isPage("agreement_create")){
				handleAutosize(); //Function to handle textarea autosize
				handleUniform();
			}
			if(App.isPage("agreement_audit")){
				handleAutosize(); //Function to handle textarea autosize
				handleUniform();
			}
			if(App.isPage("agreement_edit")){
				handleAutosize(); //Function to handle textarea autosize
				handleUniform();
			}
			if(App.isPage("sample_registration")){
				handleToggle();
			}
