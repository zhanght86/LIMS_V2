...
<script src="js/module/resultAudit.js" type="text/javascript"
	charset="utf-8"></script>
					...
					<s:iterator value="#p.inspectionSheet" id="i">
						<tr>
							...
							<td style="text-align: center;">
								...
								<c:if test="${not empty i.resultPath }">
									<a href="javascript:;" class="tablelink downRecord"
										data-id="${i.id }">查看</a>
								</c:if></td>
							<td style="text-align: center;"><a href="javascript:;"
								class="tablelink viewInspectionSheet" data-type="${i.sheetType }"
								data-id="${i.analysisProject.id }" data-projectId="${p.id }">查看</a>
							</td>
