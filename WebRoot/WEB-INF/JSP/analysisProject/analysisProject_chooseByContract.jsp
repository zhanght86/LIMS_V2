...
<body class="common" style="width: 500px">
	<div class="formbody">
		...
		<table class="tablelist" id="analysisProjectTable" style="width: 450px">
			<thead>
				<tr>
					<th>选择</th>
					<th>项目名称</th>
				...
				<s:iterator value="#items" id="i">
					<tr>
						<td style="text-align: center;">
							<input type="checkbox" data-id='${i.analysisProject.id }' data-name="${i.analysisProject.name }">
						</td>
						<td style="text-align: center;">${i.analysisProject.name }</td>
						<td style="text-align: center;">${i.analysisCategory.name }</td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
