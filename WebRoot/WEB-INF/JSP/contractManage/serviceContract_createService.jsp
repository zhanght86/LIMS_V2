...
<link href="css/cssReset.css" rel="stylesheet" type="text/css" media="print"/>
...
<body>
	<div id="content">
		...
		<h2
			...
			编号：<label style="width:100px" id="serviceCreateIdentify">请先保存合同!</label>
		</h2>
		<table cellspacing="0" cellpadding="0" id="serviceForm">
			...
			<tr>
				...
				<td colspan="8" width="621" style="padding-left:10px">甲方及时支付乙方技术咨询服务费，乙方在收到服务费和甲方提供完整﹑真实的相关项目资料后
					...
					甲方付乙方技术咨询服务费:    ${costUpper }        (￥ <label> ${cost } </label> 元) <br />
				</td>
			</tr>
			<tr>
