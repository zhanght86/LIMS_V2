...
<script src="js/module/resultReview.js" type="text/javascript"
	charset="utf-8"></script>
...
<body>
	...
	<div class="formbody">
		<div class="itab">
			<ul>
				<li><a href="#tab1" class="selected">检测结果复核</a></li>
			</ul>
		</div>
			...
			<table class="tablelist" id="auditTable">
				...
				<tbody>
					<s:iterator value="#p.inspectionSheet" id="i">
						<c:if test="${i.review.id==nowId && i.step==2}">
							<tr>
								...
								<td style="text-align: center;"><c:if test="${i.step==2 }">
