					...
					<tbody>
						<s:iterator value="#roleList" id="role">
							...
							<tr>
								...
								<c:if test="${role.identify!='JS0000'}">
								<td style="text-align: center;"><a href="javascript:;" class="tablelink userList" data-num="${role.id}">用户</a> <a
									href="javascript:;" class="tablelink changeRole"
									data-num="${role.id}">修改</a> <a href="javascript:;"
									class="tablelink limitman" data-id=${role.id }>权限</a> <a href="javascript:;"
