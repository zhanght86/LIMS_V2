	...
	<div class="formbody">
		...
		<form action="" id="deliveryAdd">
			<ul class="forminfo">
				...
				<li><label>样品编号</label><%--  <s:textarea name="sampleNameList"
						cssClass="textinput" id="sampleId" placeholder="点击选择样品编号"
						data-alert="样品编号" cssStyle="width: 350px;height: 100px"></s:textarea> --%>
