...
<body class="common">
	...
	<div class="formbody">
		...
		<ul class="forminfo">
			<li><label style="width: 150px;">样品包装情况：</label> 
			<c:if test="${project.package_condition != 1 &&project.package_condition !=2 }">
			<label for="package_good"><input
					type="radio" name="package_condition" checked="checked" value="0" id="package_good" />完好</label> 
			<label for="package_tag"><input type="radio" name="package_condition"
					value="1" id="package_tag" />破损</label> 
			<label for="package_solid"><input
					type="radio" name="package_condition" value="2" id="package_solid" />玷污</label>
			</c:if>
			<c:if test="${project.package_condition == 1 }">
			<label for="package_good"><input
					type="radio" name="package_condition"  value="0" id="package_good" />完好</label> 
			<label for="package_tag"><input type="radio" name="package_condition"
					value="1" id="package_tag"   checked="checked"/>破损</label> 
			<label for="package_solid"><input
					type="radio" name="package_condition" value="2" id="package_solid" />玷污</label>
			</c:if>
			<c:if test="${project.package_condition == 2 }">
			<label for="package_good"><input
					type="radio" name="package_condition" value="0" id="package_good" />完好</label> 
			<label for="package_tag"><input type="radio" name="package_condition"
					value="1" id="package_tag" />破损</label> 
			<label for="package_solid"><input
					type="radio" name="package_condition" value="2" id="package_solid"  checked="checked"/>玷污</label>
			</c:if>
			...
			<li><label style="width: 150px;">样品标识：</label>	<input type="text"
									style=" border:solid 1px #ced9df; height: 28px"  name="sample_Tag" value="${project.sample_Tag }"></li>
			
			<li><label style="width: 150px;">固定剂添加情况：</label>	<input type="text"
									style=" border: solid 1px #ced9df; height: 28px"
									 name="solid_Additives" value="${project.solid_Additives }" ></li>
		</ul>
