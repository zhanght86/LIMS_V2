...
<%
	...
	if(inspectionSheet!=null){
		...
		doc.openDataRegion("PO_sendSample2").setValue(inspectionSheet.getSendSample()!=null?formatDate.format(inspectionSheet.getSendSample()):""); 
	...
	poCtrl.setCaption(entity.getContractId() + "水质样品送检单");
	poCtrl.setServerPage("poserver.do");
	poCtrl.setFileTitle(entity.getContractId() + "水质样品送检单");
	poCtrl.webOpen("doc/waterInspect.doc",
