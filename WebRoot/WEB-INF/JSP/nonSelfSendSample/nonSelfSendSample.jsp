...
<script src="js/module/nonSelfSendSampleInfo.js" type="text/javascript"
	charset="utf-8"></script>
...
<body>
	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">现场采样登记</a></li>
				</ul>
			</div>
					...
					<tbody>
						<s:iterator value="#projectList" id="p">
							<tr>
								...
								<c:if test="${ empty p.nonSelfSendSampleInfo }">
									<td style="text-align: center;"><a href="javascript:;"
										class="tablelink addNonSelfSendInfo" data-id="${p.id }">登记</a></td>
								</c:if>
								<c:if test="${not empty p.nonSelfSendSampleInfo }">
									<td style="text-align: center;"><a href="javascript:;"
										class="tablelink viewSelfSendInfo" data-id="${p.id }">查看</a>&nbsp;<a href="javascript:;"
										class="tablelink addNonSelfSendInfo" data-id="${p.id }">修改</a>&nbsp;<a
