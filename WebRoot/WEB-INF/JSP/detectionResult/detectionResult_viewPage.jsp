...
<%
	...
	//打开数据区域
	InspectionSheet entity = (InspectionSheet) ActionContext
	.getContext().get("entity");
	Project pb = entity.getProject();
	...
	poCtrl.setCaption(pb.getContractId() +"原始记录表");
	poCtrl.setFileTitle(pb.getContractId() + "原始记录表");
	poCtrl.setServerPage("poserver.do");
	poCtrl.webOpen(entity.getResultPath(), OpenModeType.docReadOnly, "张三"); 
