...
<script src="js/module/sampleTransfer.js" type="text/javascript"
	charset="utf-8"></script>
...
<body>
	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">项目样品交接</a></li>
				</ul>
			</div>
				...
				<table class="tablelist" id="auditTable">
					<thead>
						<tr>
							...
							<th style="text-align: center;">送样类型</th>
							<th style="text-align: center;">任务书</th>
							<th style="text-align: center;">交联单</th>
							<th style="text-align: center;">送检单</th>
							<th style="text-align: center;">质量控制</th>
							<th style="text-align: center;">样品接收</th>
						...
						<s:iterator value="#projectList" id="p">
							<tr>
								...
								<c:if test="${p.gainSample==0 }">
									<td style="text-align: center;">现场采样</td>
								</c:if>
								<c:if test="${p.gainSample==1 }">
									<td style="text-align: center;">客户送样</td>
								</c:if>
								...
								<td style="text-align: center;"><a href="javascript:;"
										class="tablelink viewQualityControl" data-id="${p.id }">查看</a></td>
								<c:if test="${ p.gainSample==0}">
									<td style="text-align: center;"><a href="javascript:;" class="tablelink viewNonSample"
										data-id="${p.id }">操作</a></td>
								</c:if>
								<c:if test="${ p.gainSample==1}">
									<td style="text-align: center;"><a href="javascript:;" class="tablelink viewSample"
										data-id="${p.id }">操作</a></td>
								</c:if>
